...
function App() {
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <input
        type="range"
        className="w-full h-6 bg-gray accent-lime-500 hover:accent-lime-600"
      ...
      <select
        className="mt-5 w-full p-2 bg-white border-gray-300 
                         rounded-lg text-center text-xl font-bold text-gray"
        value={meses}
